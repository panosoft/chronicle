(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.report = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
module.exports = function () {
	return 'Report Helper Imported';
};
...
module.exports = {
	getData: getData,
	template: "<!doctype html>\n<html>\n<head>\n    <style>\n        @page {\n            @top { content: flow(header); }\n            @bottom { content: flow(footer); }\n        }\n        body > header { flow: static(header); }\n        body > footer { flow: static(footer); }\n    </style>\n</head>\n<body>\n{{> main }}\n</body>\n</html>", // (optional) Path || String
	helpers: {
	...
	partials: {
		main: "<style>\n    section {page-break-inside: avoid;}\n    table {\n        width: 100%;\n        border: 1px solid #ccc;\n        background: #f8f8f8;\n        border-radius: 4px;\n        th:first-child, td:first-child {text-align: left;}\n        th, td {padding: 0.4em; text-align: center;}\n        tr:nth-child(odd) td {background-color: #efefef;}\n    }\n    [negative] { color: red; }\n    img { height: 2em; }\n</style>\n\n\n<header>\n    <h1>Page Header</h1>\n</header>\n<footer>\n    <h1>Page Footer</h1>\n</footer>\n\n\n<h2>Report Header</h2>\n\n\n<h2>Groups</h2>\n<ul>\n    {{#groups}}\n    <li>{{name}}</li>\n        <ul>\n            {{#items}}\n            <li>{{name}}</li>\n            {{/items}}\n        </ul>\n    {{/groups}}\n</ul>\n\n\n<h2>Charts</h2>\n<div style=\"text-align: center\">{{> charts.chart}}</div>\n\n\n<h2>Images</h2>\n<table>\n    <tbody>\n    <tr>\n        <td>Local</td>\n        <td><img src=\"/images/person.png\"/></td>\n    </tr>\n    <tr>\n        <td>Remote</td>\n        <td><img src=\"http://www.panosoft.com/img/panoLogo.png\"/></td>\n    </tr>\n    </tbody>\n</table>\n\n\n<h2>Fonts</h2>\n<style>\n    @font-face {\n        font-family: \"local\";\n        src: url(\"/fonts/PrecisionID MICR.ttf\");\n    }\n    @font-face {\n        font-family: \"remote\";\n        src: url(\"https://www.dabitat.com/resources/fonts/cartonSlab/carton-slab.woff\");\n    }\n</style>\n<table>\n    <tbody>\n    <tr>\n        <td>Local</td>\n        <td style=\"font-family: local;\">12345 abcdefg</td>\n    </tr>\n    <tr>\n        <td>Remote</td>\n        <td style=\"font-family: remote;\">12345 abcdefg</td>\n    </tr>\n    </tbody>\n</table>\n\n\n<section>\n    <h2>Formatting</h2>\n    <table>\n        <thead>\n        <tr>\n            <th>Type</th>\n            <th>Format</th>\n            <th>Value</th>\n            <th>Formatted</th>\n        </tr>\n        </thead>\n        <tbody>\n        <tr>\n            <td>Date</td>\n            <td>-</td>\n            <td>{{date}}</td>\n            <td>{{formatDate date}}</td>\n        </tr>\n        <tr>\n            <td>Date</td>\n            <td>long</td>\n            <td>{{date}}</td>\n            <td>{{formatDate date \"long\"}}</td>\n        </tr>\n        <tr>\n            <td>Date</td>\n            <td>hhmm</td>\n            <td>{{date}}</td>\n            <td>{{formatTime date \"hhmm\"}}</td>\n        </tr>\n        <tr>\n            <td>Date</td>\n            <td>hhmmss</td>\n            <td>{{date}}</td>\n            <td>{{formatTime date \"hhmmss\"}}</td>\n        </tr>\n        <tr>\n            <td>Number</td>\n            <td>-</td>\n            <td>{{number}}</td>\n            <td>{{formatNumber number}}</td>\n        </tr>\n        <tr>\n            <td>Number</td>\n            <td>currency</td>\n            <td>{{number}}</td>\n            <td>{{formatNumber number \"currency\"}}</td>\n        </tr>\n        <tr>\n            <td>Number</td>\n            <td>percent</td>\n            <td>{{number}}</td>\n            <td>{{formatNumber number \"percent\"}}</td>\n        </tr>\n        <tr>\n            <td>Number</td>\n            <td>toWords</td>\n            <td>{{number}}</td>\n            <td>{{formatNumber number \"words\"}}</td>\n        </tr>\n        <tr>\n            <td>String</td>\n            <td>upperCase</td>\n            <td>{{string}}</td>\n            <td>{{formatString string \"upperCase\"}}</td>\n        </tr>\n        <tr>\n            <td>Conditional</td>\n            <td>-</td>\n            <td>{{numberNegative}}</td>\n            <td><span {{isNegative numberNegative}}>{{formatNumber numberNegative}}</span></td>\n        </tr>\n        </tbody>\n    </table>\n</section>\n\n\n<h2>Extending</h2>\n<h3>Helpers</h3>\n<table>\n    <thead>\n    <tr>\n        <th>Location</th>\n        <th>Embedded</th>\n        <th>Imported</th>\n    </tr>\n    </thead>\n    <tbody>\n    <tr>\n        <td>Remote (*local)</td>\n        <td>{{remoteHelperEmbedded}}</td>\n        <td>{{remoteHelperImported}}</td>\n    </tr>\n    <tr>\n        <td>Local</td>\n        <td>{{localHelperEmbedded}}</td>\n        <td>{{localHelperImported}}</td>\n    </tr>\n    </tbody>\n</table>\n\n<h3>Partials</h3>\n<table>\n    <thead>\n    <tr>\n        <th>Location</th>\n        <th>Embedded</th>\n        <th>Imported</th>\n    </tr>\n    </thead>\n    <tbody>\n    <tr>\n        <td>Remote (*local)</td>\n        <td>{{> remotePartialEmbedded}}</td>\n        <td>{{> remotePartialImported}}</td>\n    </tr>\n    <tr>\n        <td>Local</td>\n        <td>{{> localPartialEmbedded}}</td>\n        <td>{{> localPartialImported}}</td>\n    </tr>\n    </tbody>\n</table>\n\n\n\n<h2>Report Footer</h2>\n",
		remotePartialEmbedded: 'Remote Partial Embedded',
		remotePartialImported: "Report Partial Imported"
		// Server helpers(automatically loaded, can be overridden)
	},
	charts: {
		chart: function (data) {
...
},{"./helper.js":1,"lodash":3,"suspend":4}],3:[function(require,module,exports){
/**
 * @license
...
},{"../node_modules/promise/lib/es6-extensions":6}],5:[function(require,module,exports){
'use strict';
...
},{"asap":7}],6:[function(require,module,exports){
'use strict';
...
},{"./core.js":5,"asap":7}],7:[function(require,module,exports){
