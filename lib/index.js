...
var create = function (options) {
	...
	var run = suspend.promise(function * (definition, parameters) {
		...
		var html = yield templateEngine.generate(report, data); // html generator (report -> html)
		return yield renderer.render(html, parameters.renderer); // html renderer (html -> pdf)
	});
	return {
